...
// 		}
	...
	function update() {
        ...
        graphArrays(timeByteData, freqByteData, aveSoundLevel, aveFreqLevel);
...
function graphArrays(array1, array2, ave1, ave2) {
    ...
    ctx.fillStyle="green";
    ctx.fillRect(0, 300-ave1, 512, 1);
    
    ctx.fillStyle="purple";
    ctx.fillRect(512, 300-ave2, 512, 1);
